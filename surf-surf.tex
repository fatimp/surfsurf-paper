...
\begin{figure*}[!pt]
  ...
  \subfigure[Image dimensions $1500 \times 1500$, $C_{0.5} = 0.880$.]{
    \includegraphics[width=0.45\linewidth]{images/torquato-param.png}
    \label{fig:torquato-param-bad}}
  \hfill
  \subfigure[Image dimensions $5000 \times 5000$, $C_{0.5} = 0.934$]{
    \includegraphics[width=0.45\linewidth]{images/torquato-param-2.png}
    \label{fig:torquato-param-good}}
