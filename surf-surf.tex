...
%\begin{figure}
%  \centering
%  \includegraphics[width=\linewidth]{images/torquato-param.png}
%  \caption[]{Illustration of how a choice of parameters affect Ma's and
%    Torquato's algorithm. An image of overlapping disks with low resolution
%    ($1500 \times 1500$ pixels, $C_{0.5} = 0.880$). An output varies drastically
%    with a change in standard deviation of Gaussian filter.}
%  \label{fig:torquato-param}
%\end{figure}
