...
\begin{table*}[!pt]
  ...
  \begin{ruledtabular}
    \begin{tabular}{|c|c|c|c|}
      Sample name & Image type & Dimensions & Image resolution ($\mu m$) \\
      \hline
      Sandstone 1 & XCT & $500 \times 500 \times 500$ & X \\
      Sandstone 2 & XCT & $500 \times 500 \times 500$ & X \\
      Sandstone 3 & XCT & $500 \times 500 \times 500$ & X \\
      Carbonate 1 & XCT & $500 \times 500 \times 500$ & X \\
      Carbonate 2 & XCT & $500 \times 500 \times 500$ & X \\
      Carbonate 3 & XCT & $500 \times 500 \times 500$ & X \\
      Sandstone 4 & SEM & $1280 \times 869$ & X \\
      Sandstone 5 & SEM & $1280 \times 869$ & X \\
      Carbonate 4 & SEM & $1024 \times 691$ & X \\
      Carbonate 5 & SEM & $1024 \times 691$ & X \\
      Carbonate B1 & SEM & $1024 \times 691$ & X \\
      Carbonate B2 & SEM & $1024 \times 691$ & X
    \end{tabular}
  \end{ruledtabular}
...
\begin{figure*}[!pt]
  ...
  \subfigure[Sandstone 4, $C_{0.5} = 0.931$]{
    \includegraphics[width=0.14\linewidth, frame]{images/846-79_0009.png}
    \label{fig:sandstone4}}
  \hfill
  \subfigure[Sandstone 5, $C_{0.5} = 0.951$]{
    \includegraphics[width=0.14\linewidth, frame]{images/859-12_0005.png}
    \label{fig:sandstone5}}
  \hfill
  \subfigure[Carbonate 4, $C_{0.5} = 0.931$]{
    \includegraphics[width=0.14\linewidth, frame]{images/C1-1-g6_010.png}
    \label{fig:carbonate4}}
  \hfill
  \subfigure[Carbonate 5, $C_{0.5} = 0.931$]{
    \includegraphics[width=0.14\linewidth, frame]{images/C3-3-G0 (32).png}
    \label{fig:carbonate5}}
  \hfill
  \subfigure[Carbonate B1, $C_{0.5} = 0.841$]{
    \includegraphics[width=0.14\linewidth, frame]{images/C6-1-2-G2_019.png}
    \label{fig:carbonate-b1}}
  \hfill
  \subfigure[Carbonate B2, $C_{0.5} = 0.815$]{
    \includegraphics[width=0.14\linewidth, frame]{images/C6-1-2-G2_024.png}
