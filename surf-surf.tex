...
\begin{table*}[!pt]
  ...
  \begin{ruledtabular}
    \begin{tabular}{|c|c|c|c|}
      ...
      Carbonate B3 & XCT & $500 \times 500 \times 500$ & 1.7 \\
      Carbonate B4 & XCT & $500 \times 500 \times 500$ & 1.7
    \end{tabular}
  \end{ruledtabular}
...
\begin{figure*}[!pt]
  ...
  \subfigure[Carbonate B3, $C_{0.5} = 0.912$]{
    \includegraphics[width=0.22\linewidth, frame]{images/carbRNF1_500.png}
    \label{fig:carbonate-b3}}
  \subfigure[Carbonate B4, $C_{0.5} = 0.888$]{
    \includegraphics[width=0.22\linewidth, frame]{images/carbRNF2_500.png}
    \label{fig:carbonate-b4}}
  \caption[]{Examples of XCT and SEM images which do not satisfy our $C_{0.5}$
    criterion.}
...
Intel Xeon Gold 6248R CPU with \textcolor{red}{YYY} RAM and Nvidia GeForce RTX
3090 GPU. Input data consists of 2D and 3D square bit arrays with side varying
from 1000 to 10000 with step 1000 (2D case) or from 100 to 1000 with step 100
(3D case). The execution times are on \cref{fig:exec-times}. As our video RAM is
limited the GPU can process three dimensional arrays with dimensions no more
than $700 \times 700 \times 700$. A speedup from use of GPU is about 30 times.
