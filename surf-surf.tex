...
Their algorithm is very sensitive to selection of standard deviation $\sigma$ of
Gauss filter and it is not clean how to select this parameter properly
...
\begin{figure*}[!pt]
  ...
  \caption[]{Illustration of how a choice of $\sigma$ affects Ma's and
    ...
    algorithm produce results highly dependant on $\sigma$ in the both cases.}
...
\begin{figure*}[!pt]
  ...
  \subfigure[Grayscale image.]{
    \includegraphics[width=0.45\linewidth]{images/berea-slice.png}
    \label{fig:torquato-berea}}
  \hfill
  \subfigure[Surface-surface correlation function.]{
    \includegraphics[width=0.45\linewidth]{images/torquato-berea.png}
    \label{fig:torquato-berea-ss}}
  \caption[]{A two-dimensional slice of Berea sandstone\cite{sandstone-dataset}
    (\cref{fig:torquato-berea}) and surface-surface correlation functions
    computed with different threshold parameter $T$
    \cref{fig:torquato-berea-ss}.}
